...
#include <stdio.h>
// this is included so that we can use native logging commands (ESP_LOG*(), in longhand)
#include <esp_log.h>
...
void app_main(void){
    ...
    //   "Hello, World! Welcome to the ESP32!", whereas
    // ESP_LOGI("meta", "Hello, World! Welcome to the ESP32!"); outputs:

    ESP_LOGI("meta", "Hello, World! Welcome to the ESP32!");
